...
contract Publisher {
    ...
    */
     ...
     */
    function createContent(string memory _contentHash, string memory _previewHash, string memory _name, string memory _fileType, bool _free, uint _price) public payable{
