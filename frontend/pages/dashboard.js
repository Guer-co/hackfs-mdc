...
return (
    ...
    <Grid centered columns={3}>
        <Grid.Column>
                ...
                <p>For now, simple implementation / data dump of all of your files in ipfs.</p>
                <div>
                        ...
                        if (result[0] !== null && result[0] !== undefined && result[0] !== "") {
                            return (
                                <div className="imagebox" key={result[0]}>
                                    <div>
                                        <a rel="noopener noreferrer" target="_blank" href={"https://gateway.ipfs.io/ipfs/" + result[0]}><img alt="pic" src={"https://gateway.ipfs.io/ipfs/" + result[0]} style={{width:'80%'}}/></a>
                                    </div>
                                    <div>
                                        <p>{result[1]}</p>
                                        <p>Uploaded: <Moment format="MM/DD/YY HH:mm" unix>{result[2]}</Moment></p>
                                    </div>
                                    <br/>
                                    <hr/>
                                </div>
