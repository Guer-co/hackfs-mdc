        ...
        {filehash === '' ? (
            ...
            */}
            ...
            <Form>
                ...
                One time price for this content in {usd ? "$USD" : <Icon name='ethereum'>Eth</Icon>} <Button onChange={() => setUsd(!usd)}>Use {usd ? "ETH" : "USD"} Instead</Button>
                </div>
                <Form.Field>
                    <div class="ui labeled input">
                    <div class="ui label label">{usd ? <Icon name='usd'>USD</Icon> : <Icon name='ethereum'>ETH</Icon>}</div>
