...
const TestPage = () => {
  ...
  const enterGateway = async () => {
    ...
    console.log(GatewayContractObj)
    // const userContract = await GatewayContractObj.methods.createSimple().send({ from: dapp.address });
    ...
    <Grid centered columns={2}>
      <Grid.Column>
        <div style={{ marginTop: '100px' }}>
          ...
          <br />
          <Button onClick={enterGateway} >Create your own smart contract on Pay3!</Button>
          <br />
          <hr />
          ...
          <hr />
          <h3>
            3. Store that piece of data in your smart contract (non-functioning)
          </h3>
          <br />
          <div>
            {' '}
